...
arg: sc_specifier typ ID        { ($1, $2, $3, (-1,-1), Noexpr) }
...
var_decl_list:  /* nothing */   { [] }   /* when function has no args */
  | var_decl_list vdecl         { $2 :: $1 }

vdecl:
  /* declaration without definition */
    sc_specifier typ ID SEMICOLON             { check_primitive $1 $2 $3 Noexpr }
  | sc_specifier typ ID typ_size SEMICOLON    { check_non_primitive $1 $2 $3 $4 Noexpr }
  /* declaration with definition */
  | sc_specifier typ ID ASSIGN expr SEMICOLON { check_primitive $1 $2 $3 $5 }
  | sc_specifier typ ID typ_size ASSIGN expr SEMICOLON { check_non_primitive $1 $2 $3 $4 $6 }
...
expr:  INTLIT             { Int($1) }
  ...
  | ID LBRACK expr COMMA expr RBRACK               { MatrixPart($1, $3, $5) }  
...
matrix_lit_col:
  ...
  | matrix_lit_col COMMA LBRACK matrix_lit_row RBRACK { Array.append $1 [|$4|] }
